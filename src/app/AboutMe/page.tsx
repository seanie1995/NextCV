      ...
      <div className='grid lg:grid-cols-2 gap-12 lg:gap-20 items-center'>
        ...
        <div className='space-y-6'>
          ...
          <p className='text-lg text-gray-300 leading-relaxed'>
            Hi, I&apos;m{' '}
            <span className='text-purple-400 font-semibold'>Sean Schelin</span>,
          ...
          <p className='text-lg text-gray-300 leading-relaxed'>
            For me, the goal isn&apos;t simply to sharpen my own skills for
            their own sake. What matters is how those skills can serve others —
            to contribute, support, and create space where others can thrive as
            well.
          </p>
